...
def convert_namespace_to_omegaconf(args: Namespace) -> DictConfig:
    ...
    if hasattr(cfg, "model") and cfg.model is not None:
        assert cfg.model.attn_name_encoder == args.attn_name_encoder
        assert cfg.model.attn_name_encoder == args.attn_name_encoder
        cfg.model.attn_args_encoder = vars(args.attn_args_encoder)
        cfg.model.attn_args_decoder = vars(args.attn_args_decoder)
