...
from fairseq.modules import LayerNorm, MultiheadAttention, EfficientAttention
...
class TransformerDecoderLayerBase(nn.Module):
    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def build_self_attention(
        ...
        if cfg.attn_name_decoder == "causal_eva":
            from efficient_attention import CausalEVAttention
            return CausalEVAttention(
                embed_dim,
                ...
                q_noise=self.quant_noise,
                qn_block_size=self.quant_noise_block_size,
                attn_args=Namespace(**cfg.attn_args_decoder),
            )
        elif cfg.attn_name_decoder == "softmax":
            ...
            raise NotImplementedError("Decoder-side attention methods other than [causal_eva, softmax] are not supported yet.")
