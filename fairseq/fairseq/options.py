...
def parse_args_and_arch(
    ...
    if hasattr(args, "arch"):
        ...
        AttentionFactory.add_attn_specific_args(parser, args.attn_name_encoder, struct_name="attn_args_encoder", prefix="encoder-attn")
        AttentionFactory.add_attn_specific_args(parser, args.attn_name_decoder, struct_name="attn_args_decoder", prefix="decoder-attn")
    ...
    from efficient_attention import NestedNamespace
    # Parse a second time.
    if parse_known:
        args, extra = parser.parse_known_args(input_args, namespace=NestedNamespace())
    else:
        args = parser.parse_args(input_args, namespace=NestedNamespace())
        extra = None
    # Post-process args.
    if (
...
def add_model_args(parser):
    ...
    group.add_argument("--attn-name-encoder", default='softmax', type=str)
    group.add_argument("--attn-name-decoder", default='softmax', type=str)
    # fmt: on
    return group
